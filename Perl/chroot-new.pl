...
#system("yum install -y yum-plugin-priorities");
$hostname = `hostname`;
...
close FILE;
open (FILE, ">>/etc/sysconfig/iptables.restore");
print FILE"# Generated by iptables-save v1.3.5 on Mon Oct 15 21:28:31 2012
*filter
...
COMMIT
# Completed on Mon Oct 15 21:28:31 2012
";
close FILE;
...
close FILE;
open (FILE, ">>/etc/resolv.conf");
print FILE "; generated by /sbin/dhclient-script
search ec2.internal
search hcaws.net
search live.hcaws.net
nameserver 10.2.0.2
";
close FILE;
